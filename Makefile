...
ACLOCAL = ${SHELL} '/usr/src/packages/BUILD/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/usr/src/packages/BUILD/missing' autoconf
AUTOHEADER = ${SHELL} '/usr/src/packages/BUILD/missing' autoheader
AUTOMAKE = ${SHELL} '/usr/src/packages/BUILD/missing' automake-1.16
AWK = gawk
CSCOPE = cscope
CTAGS = ctags
CYGPATH_W = echo
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/usr/src/packages/BUILD/missing' makeinfo
...
STRIP = 
VERSION = 20240622
abs_builddir = /usr/src/packages/BUILD
abs_srcdir = /usr/src/packages/BUILD
abs_top_builddir = /usr/src/packages/BUILD
abs_top_srcdir = /usr/src/packages/BUILD
am__leading_dot = .
...
install_sh = ${SHELL} /usr/src/packages/BUILD/install-sh
